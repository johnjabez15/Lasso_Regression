...
try:
    ...
    print("Please run lasso_model.py first to train and save the model.")
    exit()
...
def predict():
    ...
    and then uses the loaded Lasso Regression model to make a prediction.
    ...
    try:
        ...
        # Format the prediction to two decimal places and add the currency symbol
